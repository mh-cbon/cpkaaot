...
var Connector = function () {
  ...
  this.enable = function (stdout, stderr) {
    ...
    var pipeStdout = function () {
      if(stdout) {
        ...
        remoteStdout = stdout.write ? stdout : uriToStream.write(stdout);
    ...
    var pipeStderr = function () {
      if (stderr) {
        ...
        remoteStderr = stderr.write ? stderr : uriToStream.write(stderr);
  ...
  this.destroy = function () {
    ...
    that.disable();
    remoteStdout && remoteStdout.removeAllListeners('end')
    remoteStderr && remoteStderr.removeAllListeners('end')
